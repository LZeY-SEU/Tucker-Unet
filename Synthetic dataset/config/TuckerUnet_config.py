...
# Training parameters
BATCH_SIZE = 81     # 32 for 128*128,   100 for 64*64, while 512 for 28*28
LEARNING_RATE = 1e-4
EPOCHS = 300
WEIGHT_DECAY = 0.01
...
# Sampling parameters
SAMPLE_BATCHES = 64  # Number of batches to sample, often 64
SAMPLES_PER_BATCH = 32    # Number of samples per batch, 20 for 128*128,  32 for 64*64, while 128 for 28*28
