...
from TuckerUnet import  ConvUnet, GaussianDiffusion, Trainer
import config.ConvUnet_config as config
...
def train_model(data_path, seed=None, num_samples=None, gpu_id=0, epochs=None,channels=None):
    """
